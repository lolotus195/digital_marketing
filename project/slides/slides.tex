...
\includegraphics[width=\textwidth]{coefs_base.pdf}
\end{frame}

\begin{frame}
More main effects than interaction effects
\includegraphics[width=\textwidth]{coefs_int.pdf}
\end{frame}

\begin{frame}
At least one (and maybe two) variables with no predictive power
\includegraphics[width=\textwidth]{coefs_missing.pdf}
\end{frame}
